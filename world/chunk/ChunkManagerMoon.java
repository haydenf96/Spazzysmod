...
public class ChunkManagerMoon implements IChunkProvider
{
            ...
            for (int var9 = 0; var9 < 16; ++var9)
            {
                ...
                for (int var16 = 127; var16 >= 0; --var16)
                {
                    ...
                    else
                    {
                        ...
                        else if (var18 == Spazzysmod.moonStone.blockID)
                        {
                            if (var13 == -1)
                            {
                                if (var12 <= 0)
                                ...
                                if (var16 < var5 && var14 == 0)
                                {
                                    if (var11 < 0.15F)
                                    {
                                        var14 = (byte)Spazzysmod.moonStone.blockID;
                                    }
                                    else
                                    {
                                        var14 = (byte)Spazzysmod.moonStone.blockID;
                            ...
                            else if (var13 > 0)
                            {
                                ...
                                if (var13 == 0 && var15 == Spazzysmod.moonStone.blockID)
                                {
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
    {
                ...
                !flag && this.rand.nextInt(4) == 0)
        {
            ...
            (new WorldGenLakes(Spazzysmod.moonStone.blockID)).generate(this.worldObj, this.rand, k1, l1, i2);
        }
