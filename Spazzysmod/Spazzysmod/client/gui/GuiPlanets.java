...
public class GuiPlanets extends GuiScreen {
	...
	public void initGui() {
		...
		this.buttonList.add(overworld = new GuiButton(0, this.width / 2 - 100,
				this.height / 4 + 24 + b0, "Overworld"));
		this.buttonList
				.add(moon = new GuiButton(1, this.width / 2 - 100, this.height
						/ 4 + 44 + b0, SpazzysPlanets.MOON.getPlanetName()));
		this.buttonList
				.add(mars = new GuiButton(2, this.width / 2 - 100, this.height
						/ 4 + 64 + b0, SpazzysPlanets.MARS.getPlanetName()));
	...
	protected void actionPerformed(GuiButton par1GuiButton) {
		...
		if (par1GuiButton.id == 0) {
			if (thePlayer.dimension != 0) {
				...
				ItemStack itemstack = new ItemStack(SpazzysItems.spaceship, 1,
						0);
	...
	public void drawScreen(int par1, int par2, float par3) {
		...
		this.drawCenteredString(this.fontRenderer, "Select A Planet",
