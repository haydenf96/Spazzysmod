...
import spazzysmod.client.model.ModelAlien;
...
public class RenderAlien extends RenderLiving {
 ...
 private static final ResourceLocation texture = new ResourceLocation("spazzysmod:textures/models/Alien.png");
    protected ModelGopher ModelGopher;

    public RenderAlien() {
        super(new ModelAlien(), 0.5F);
        this.mainModel = (ModelAlien) this.mainModel;
