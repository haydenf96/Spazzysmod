package spazzysmod.client.gui.inventory.slot;
...
public class SlotRocket extends Slot {
	...
	public SlotRocket(EntityPlayer par1EntityPlayer, IInventory par2IInventory,
			...
			if (itemstack1 != null) {
				...
				if (itemstack1.getItem().hasContainerItem()) {
					...
					ItemStack itemstack2 = itemstack1.getItem()
							.getContainerItemStack(itemstack1);
					...
					if (itemstack2 != null
							&& (!itemstack1.getItem()
									.doesContainerItemLeaveCraftingGrid(
											itemstack1) || !this.thePlayer.inventory
