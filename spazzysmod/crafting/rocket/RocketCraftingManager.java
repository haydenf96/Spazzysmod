...
public class RocketCraftingManager {
	...
	private RocketCraftingManager() {
		...
		Collections.sort(this.recipes, new RocketRecipeSorter(this));
		System.out.println(this.recipes.size() + " recipes");
	}

	public static RocketShapedRecipes func_92051_a(ItemStack par1ItemStack,
		...
		RocketShapedRecipes var17 = new RocketShapedRecipes(var5, var6, var15,
				par1ItemStack);
		recipes.add(var17);
		return var17;
	}
	...
	public void addBuilderShapelessRecipe(ItemStack par1ItemStack,
		...
		this.recipes.add(new RocketShapelessRecipes(par1ItemStack, var3));
	}
