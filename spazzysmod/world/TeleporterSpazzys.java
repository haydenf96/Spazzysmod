...
public class TeleporterSpazzys extends Teleporter {
	...
	{   
		...
		if(world.isAirBlock((int)entity.posX, (int)entity.posY -2, (int)entity.posZ))
		{		
			if(entity.dimension == 25)
			{								
				world.setBlock((int)entity.posX, (int)entity.posY -1, (int)entity.posZ, SpazzysBlocks.launchPad.blockID);
				world.setBlock((int)entity.posX + 1, (int)entity.posY -1, (int)entity.posZ, SpazzysBlocks.launchPad.blockID);
				world.setBlock((int)entity.posX - 1, (int)entity.posY -1, (int)entity.posZ, SpazzysBlocks.launchPad.blockID);
				world.setBlock((int)entity.posX + 1, (int)entity.posY -1, (int)entity.posZ + 1, SpazzysBlocks.launchPad.blockID);
				world.setBlock((int)entity.posX - 1, (int)entity.posY -1, (int)entity.posZ - 1, SpazzysBlocks.launchPad.blockID);
				world.setBlock((int)entity.posX, (int)entity.posY -1, (int)entity.posZ + 1, SpazzysBlocks.launchPad.blockID);
				world.setBlock((int)entity.posX, (int)entity.posY -1, (int)entity.posZ - 1, SpazzysBlocks.launchPad.blockID);
				world.setBlock((int)entity.posX + 1, (int)entity.posY -1, (int)entity.posZ - 1, SpazzysBlocks.launchPad.blockID);
				world.setBlock((int)entity.posX - 1, (int)entity.posY -1, (int)entity.posZ - 1, SpazzysBlocks.launchPad.blockID);
	...
	public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
	{
		...
		if (d3 >= 0.0D)
		{
			if (flag)
			{
				this.field_85191_c.add(j1, new PortalPosition(this, i, j, k, this.world.getTotalWorldTime()));
			...
			if (j2 > -1)
			{
				...
				boolean flag1 = !this.world.isAirBlock(i + i3 + k3, j, k + j3 + l3) || !this.world.isAirBlock(i + i3 + k3, j + 1, k + j3 + l3);
				boolean flag2 = !this.world.isAirBlock(i + i3, j, k + j3) || !this.world.isAirBlock(i + i3, j + 1, k + j3);
				...
				if (flag1 && flag2)
				{
					...
					int i4 = k - l3;
					d4 -= (double)l3;
					flag1 = !this.world.isAirBlock(k1 + i3 + k3, j, i4 + j3 + l3) || !this.world.isAirBlock(k1 + i3 + k3, j + 1, i4 + j3 + l3);
					flag2 = !this.world.isAirBlock(k1 + i3, j, i4 + j3) || !this.world.isAirBlock(k1 + i3, j + 1, i4 + j3);
				}
			...
			//	Structures.createRocketWithPos(par1Entity, world, (int)d8 - 8, (int)d9, (int)d4);		
			return true;
		}
		else
		{
	...
	public void placeInPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
	{
		...
		else
		{
			...
			//Structures.createRocketWithPos(par1Entity, world, (int)par2 - 8, (int)par4, (int)par6);	
		}
	}
