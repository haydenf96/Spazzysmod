...
public class SpazzysItems {
	...
	public static void initItems() {
		...
		spaceHelmet = new ItemSpacesuit(SpazzysConfig.spaceHelmetID,
				SPACESUIT, ModLoader.addArmor("Spacesuit"), 0)
		.setUnlocalizedName("spaceHelmet").setCreativeTab(
				SpazzysTabs.tabSolarSystem);
		LanguageRegistry.addName(spaceHelmet, "Space Helmet");
		GameRegistry.registerItem(spaceHelmet, "Space Helmet");

		spaceJacket = new ItemSpacesuit(SpazzysConfig.spaceJacketID,
				SPACESUIT, ModLoader.addArmor("Spacesuit"), 1)
		.setUnlocalizedName("spaceJacket").setCreativeTab(
				SpazzysTabs.tabSolarSystem);
		LanguageRegistry.addName(spaceJacket, "Space Jacket");
		GameRegistry.registerItem(spaceJacket, "Space Jacket");

		spacePants = new ItemSpacesuit(SpazzysConfig.spacePantsID,
				SPACESUIT, ModLoader.addArmor("Spacesuit"), 2)
		.setUnlocalizedName("spacePants").setCreativeTab(
				SpazzysTabs.tabSolarSystem);
		LanguageRegistry.addName(spacePants, "Space Pants");
		GameRegistry.registerItem(spacePants, "Space Pants");

		spaceShoes = new ItemSpacesuit(SpazzysConfig.spaceShoesID,
				SPACESUIT, ModLoader.addArmor("Spacesuit"), 3)
		.setUnlocalizedName("spaceShoes").setCreativeTab(
				SpazzysTabs.tabSolarSystem);
		...
		.setUnlocalizedName("spaceship").setCreativeTab(SpazzysTabs.tabSolarSystem);
